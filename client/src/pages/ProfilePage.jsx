...
const ProfilePage = () => {
  ...
  return (
    ...
    justify-center'>
      ...
      border-gray-600 flex items-center justify-center justify-between max-sm:flex-col-reverse
      rounded-lg'>
        ...
        <input value={name} onChange={(e)=>setName(e.target.value)} type="text" className='p-2
        border border-gray-500 rounded-md focus:outline-none focus:ring-2
        focus:ring-blue-400' placeholder='Enter your name'/>
        <textarea value={bio} onChange={(e)=>setBio(e.target.value)} rows={4} className='p-2
        border border-gray-500 rounded-md focus:outline-none focus:ring-2
        focus:ring-blue-400' placeholder='Enter your bio'/>
        <button  type='submit' className='bg-gradient-to-r from-purple-400 to-blue-800
