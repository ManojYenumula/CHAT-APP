...
const SideBar = () => {
  ...
  return (
    <div className={`bg-[#8185B2]/10 h-full p-5 ronded-r-xl overflow-y-scroll
    ...
    <div className='pb-5'>
      <div className='flex justify-between items-center'>
        ...
        <div className={`absolute top-full right-0 z-20 w-32 p-5 rounded-md
         bg-[#282142] border-gray-600 text-gray-100  ${menuOpen ? "block" : "hidden"} `}>
    ...
    <div className='flex flex-col'>
      {filteredUsers.map((user,index)=>(
        ...
        ({...prev, [user._id]:0}))}} className={`relative flex items-center gap-2 p-2
    pl-4 rounded cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}>
